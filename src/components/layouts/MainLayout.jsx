...
export default function MainLayout({ children }) {
  ...
  const menuItems = [
    ...
    { key: '/tasks/create', icon: <PlusOutlined />, label: <Link to="/tasks/create">Create Task</Link> },
  ];

  const selectedKey = menuItems.find(item => location.pathname.includes(item.key.replace('/', '')))?.key || '/';
