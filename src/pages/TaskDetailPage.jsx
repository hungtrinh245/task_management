import { Card, Button, Space, Tag, Divider, Row, Col, Spin, Descriptions } from 'antd';
        ...
        <Descriptions bordered column={{ xxl: 2, xl: 2, lg: 1, md: 1, sm: 1, xs: 1 }}>
          ...
          <Descriptions.Item label="Description" span={2}>
            <div style={{
              ...
              {task.description || <span style={{ color: '#999' }}>No description provided</span>}
            </div>
          </Descriptions.Item>
        </Descriptions>
        ...
        <Row gutter={16} style={{ marginTop: 24 }}>
          ...
          <Col xs={24} sm={12}>
            <Card size="small" style={{ borderRadius: 4 }}>
              <div style={{ textAlign: 'center' }}>
                <h4>Status</h4>
                <Tag color={task.completed ? 'green' : 'orange'} style={{ marginTop: 8 }}>
